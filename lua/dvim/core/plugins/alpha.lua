...
M.config = function()
  local dvim_dashboard = require("dvim.core.plugins.alpha.dashboard")
  local dvim_startify = require("dvim.core.plugins.alpha.startify")

  dvim.builtin.plugins.alpha = {
    active = true,
    mode = "dashboard",
...
local function resolve_config(theme_name)
  ...
  local section = dvim.builtin.plugins.alpha[theme_name].section
...
M.setup = function()
  ...
  local mode = dvim.builtin.plugins.alpha.mode
  local config = dvim.builtin.plugins.alpha[mode].config
