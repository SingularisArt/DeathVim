...
function M.setup()
  ...
  dvim.builtin.nvimtree._setup_called = true

  -- Implicitly update nvim-tree when project module is active
  if dvim.builtin.project.active then
    dvim.builtin.nvimtree.setup.respect_buf_cwd = true
    dvim.builtin.nvimtree.setup.update_cwd = true
    dvim.builtin.nvimtree.setup.update_focused_file = { enable = true, update_cwd = true }
  end
  ...
  -- Add useful keymaps
  if #dvim.builtin.nvimtree.setup.view.mappings.list == 0 then
  ...
  nvim_tree.setup(dvim.builtin.nvimtree.setup)

  if dvim.builtin.nvimtree.on_config_done then
    dvim.builtin.nvimtree.on_config_done(nvim_tree)
  end
end
