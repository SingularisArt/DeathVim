...
vim.api.nvim_set_keymap('n', '<Leader>bmf',   ':BufferLineMoveNext<CR>',                  { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<Leader>bmb',   ':BufferLineMovePrev<CR>',                  { noremap = true, silent = true })
