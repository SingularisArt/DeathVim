...
function! SingularisArt#debug#autocmds(log) abort
...
function! SingularisArt#debug#compiler() abort
...
function! SingularisArt#debug#log(string) abort
  call writefile([a:string], '/tmp/SingularisArt-vim-debug.txt', 'aS')
endfunction
