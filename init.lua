...
if vim.o.loadplugins then
  ...
  SingularisArt.plugin.load("firenvim")
  ...
  SingularisArt.plugin.load("litee-bookmarks.nvim")
  SingularisArt.plugin.load("litee-calltree.nvim")
  ...
  SingularisArt.plugin.load("lsp_lines.nvim")
  ...
  SingularisArt.plugin.load("navigator.lua")
  ...
  SingularisArt.plugin.load("nvim-dap-python")
  ...
  SingularisArt.plugin.load("todo-comments.nvim")
  ...
  SingularisArt.plugin.load("virtual-types.nvim")
...
vim.opt.foldexpr = "v:nvim_treesitter#foldexpr()" -- use treesitter's folding
